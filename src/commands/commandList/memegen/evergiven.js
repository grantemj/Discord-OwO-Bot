...
module.exports = new CommandInterface({
	...
	alias:["evergiven","evergreen","excavator"],

	args:"{evergivenText|@user|emoji} | {excavatorText|@user|emoji}",

	desc:"Creates an evergiven meme! Seperate the three arguments with a '|' bar, or press 'Shift+Enter' between arguments",

	example:["owo evergiven my depression and anxiety | going on a walk","owo evergreen cost of what I want to buy | money in my wallet"],
	...
	execute: function(p){
		...
		canvasUtil.loadBackground('./src/data/images/evergiven.jpg',function(err,ctx,canvas,image){
			if(err){
